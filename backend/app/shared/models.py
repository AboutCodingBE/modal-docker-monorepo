...
class Embedding(Base):
    ...
    __table_args__ = (
        UniqueConstraint("file_id", "chunk_index", name="uq_embeddings_file_id_chunk_index"),
    )
    ...
    # settings.embedding_dimension i.p.v. hardcoded — zie de sync-opmerking bij die setting
