...
from app.get_timeline_heatmap.router import router as get_timeline_heatmap_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:4210"],
...
app.include_router(get_timeline_heatmap_router)
