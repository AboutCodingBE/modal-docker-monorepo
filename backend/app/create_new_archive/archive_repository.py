...
class ArchiveRepository:
    ...
    def persist(self, name: str, root_path: str) -> Archive:
        archive = Archive(name=name, root_path=root_path)
        self._session.add(archive)
        self._session.flush()
        return archive

    def update_status(self, archive: Archive, status: str, error_message: str | None = None) -> None:
    ...
    def update_statistics(self, archive: Archive, file_count: int, directory_count: int, total_size_bytes: int) -> None:
