...
Invoke-Progress 'Starting Docker services without resetting database volumes'
& docker compose up -d
...
Write-Host 'Development stack is starting with the existing database.' -ForegroundColor Green
